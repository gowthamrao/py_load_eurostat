...
class Code(BaseModel):
    ...
    name: str = Field(description="The human-readable name of the code (e.g., 'Germany').")
...
class Attribute(BaseModel):
    ...
    codelist_id: Optional[str] = Field(default=None, description="The ID of the code list for this attribute, if any.")
...
class DSD(BaseModel):
    ...
    dimensions: List[Dimension] = Field(description="The list of dimensions in the DSD.")
    attributes: List[Attribute] = Field(description="The list of attributes in the DSD.")
    primary_measure_id: str = Field(default="OBS_VALUE", description="The ID of the primary measure (observation value).")
